...
int main()
{
	...
	BaseAuto = Model();
	BaseAuto.LoadModel("Models/cuerpo_carro.obj");
	CofreAuto = Model();
	CofreAuto.LoadModel("Models/cofre.obj");
	RuedaTraseraIzquierda = Model();
	RuedaTraseraIzquierda.LoadModel("Models/Llanta_TI.obj");
	RuedaTraseraDerecha = Model();
	RuedaTraseraDerecha.LoadModel("Models/Llanta_DI.obj");
	RuedaDelanteraIzquierda = Model();
	RuedaDelanteraIzquierda.LoadModel("Models/Llanta_TD.obj");
	RuedaDelanteraDerecha = Model();
	RuedaDelanteraDerecha.LoadModel("Models/Llanta_DD.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Coche jerárquico con model
		

		color = glm::vec3(0.1f, 0.2f, 0.6f); // color base
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.5f, 0.15f, -3.60f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		CofreAuto.RenderModel();

		// Color para las ruedas
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.75f, -1.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.8f, -1.0f, -4.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.75f, -1.0f, -4.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
