...
Teclas de la F a la K para rotaciones de articulaciones y patas
Teclas de la U a la P para rotaciones de ruedas
Tecla L para la rotacion de la cola 
*/
#include <stdio.h>
#include <string.h>
#include<cmath>
...
int main()
{
	...
	CrearCilindro(500, 1.0f);     // índice 2
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// extremo derecho del segundo brazo
		...
		// BASE DE LA COLA DEL PERRO
		glm::mat4 modelTail = glm::translate(glm::mat4(1.0f), glm::vec3(1.0f, 0.0f, -4.0f)); // Posicionamos la base de la cola
		modelTail = glm::rotate(modelTail, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotación de la base
